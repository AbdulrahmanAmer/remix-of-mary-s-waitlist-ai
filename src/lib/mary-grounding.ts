...
const AFFIRMATION_START = new Set([
  "yes", "yeah", "yep", "yup", "exactly", "correct", "right", "thats", "that's", "pretty",
  "close", "spot", "sure", "indeed", "bingo", "you", "true", "absolutely", "definitely",
  "precisely", "mhm", "uh-huh", "yea", "ya", "affirmative", "totally", "basically", "more",
]);
const NEGATION = new Set([
  "no", "not", "nope", "nah", "but", "actually", "wrong", "isnt", "arent", "dont", "never",
  "rather", "instead", "except", "although", "though", "however", "different",
]);
...
const VERTICAL_VALUE = [
  "real", "estate", "realtor", "realty", "brokerage", "broker", "mortgage", "mortgages",
  "lending", "lender", "loan", "loans", "listings", "financial", "finance", "insurance",
  "wealth", "advisor", "advisory", "bank", "banking", "credit", "investment", "investments",
];
const VERTICAL_HINTS = new Set([
  ...VERTICAL_VALUE, "house", "houses", "home", "homes", "property", "properties", "listing",
  "buyers", "sellers", "agent", "agents", "refinance", "refi", "escrow", "closing", "closings",
  "rentals", "landlord", "tenants", "commercial", "residential", "underwriting", "fha", "rates",
  "premiums", "policies", "policy", "portfolio", "clients", "showings", "showing", "sold",
  "selling", "buying", "invest", "investing", "realtors", "estates", "leasing", "lease",
]);

function assumesVertical(value: string, userText: string, lastAssistant?: string, lastUser?: string) {
  const v = tokens(value);
...
const NUMBER_WORDS: Record<string, string> = {
  ...
  seven: "7", eight: "8", nine: "9", double: "", triple: "",
};
